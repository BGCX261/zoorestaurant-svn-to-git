...
/**
 * ParrillaLibre filter form base class.
 *
 * @package    filters
 * @subpackage ParrillaLibre *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BaseParrillaLibreFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('parrilla_libre_filters[%s]');

...
/**
 * Ensalada form base class.
 *
 * @package    form
 * @subpackage ensalada
 * @version    SVN: $Id: sfDoctrineFormGeneratedTemplate.php 8508 2008-04-17 17:39:15Z fabien $
 */
class BaseEnsaladaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'            => new sfValidatorDoctrineChoice(array('model' => 'Ensalada', 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ensalada[%s]');

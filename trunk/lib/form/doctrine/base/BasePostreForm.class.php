...
/**
 * Postre form base class.
 *
 * @package    form
 * @subpackage postre
 * @version    SVN: $Id: sfDoctrineFormGeneratedTemplate.php 8508 2008-04-17 17:39:15Z fabien $
 */
class BasePostreForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'            => new sfValidatorDoctrineChoice(array('model' => 'Postre', 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('postre[%s]');

...
/**
 * PlatoPrincipal form base class.
 *
 * @package    form
 * @subpackage plato_principal
 * @version    SVN: $Id: sfDoctrineFormGeneratedTemplate.php 8508 2008-04-17 17:39:15Z fabien $
 */
class BasePlatoPrincipalForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'            => new sfValidatorDoctrineChoice(array('model' => 'PlatoPrincipal', 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('plato_principal[%s]');
